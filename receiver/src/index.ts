...
setTimeout(() => {
  ...
  player.init().then(() => {
    ...
    setTimeout(() => {
      ...
      const url =
        "https://edge1.salomtv.uz:11610/auth-streaming/3,bec848bf4af483a5eec664bba31f17ab34a38636,1706869137,nauman,0-A4674-hls-UNIQCAST,8,8,8,8,8,8,8,8,DESKTOP,318,all,none,default,2.51.51.90/hls/vod/0-A4674-hls-UNIQCAST/playlist.m3u8";
      const license =
